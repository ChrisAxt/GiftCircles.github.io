...
-- Drop ALL versions of create_list_with_people
drop function if exists public.create_list_with_people(uuid, text, list_visibility, uuid[], uuid[], uuid[], text);
drop function if exists public.create_list_with_people(uuid, text, text, uuid[], uuid[], uuid[], text);
