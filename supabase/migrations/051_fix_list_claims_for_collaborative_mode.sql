-- Migration: Fix list_claims_for_user to support collaborative mode
-- Date: 2025-01-20
-- Description: In combined random assignment (collaborative mode), users are both givers
--              and recipients, so they should see claims assigned to them even though they're
--              also list recipients. The non_recipient_items filter was blocking this.
